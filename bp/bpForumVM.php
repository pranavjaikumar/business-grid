...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion primary-background" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item" href = "bpDashboard.php">
            <a class="nav-link">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="bpForum.php">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="bpForumTable" width="100%" cellspacing="0">
                                <thead>
                                <tr>
                                    <th>First</th>
                                    <th>Last</th>
...
<script src="../js/demo/bpForum.js"></script>
