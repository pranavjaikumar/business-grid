            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h4 class="m-0 font-weight-bold text-primary">Business Professionals on The Business Grid</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="sBPtable" width="100%" cellspacing="0">
                                <thead>
                                <tr>
                                    <th>First</th>
                                    <th>Last</th>
...
<script src="../js/demo/sBP.js"></script>
