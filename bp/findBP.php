...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion primary-background" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item">
            <a class="nav-link" href="../startup/startupDashboard.php">
        ...
        <!-- Nav Item - Tables -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="../startup/findStartup.php">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="../startup/startupProfile.php">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="dropdown-list dropdown-menu shadow" aria-labelledby="sortDropdown">
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div>
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary prim-text">Top Choices</h6>
                                <div class="dropdown no-arrow">
                                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                        <div class="dropdown-header">Menu Options</div>
                                            ...
                                            <div class="card-body">
                                                <a style="color: #0099ff" class="nav-link" href="#" id="sortDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <span>
                                                        <?php
                                                            include "config.php";
                                                            $bp_profiles = mysqli_query($link, "SELECT * FROM bp_profile");
                                                            $profile = mysqli_fetch_array($bp_profiles);
                                                            $id = $profile['id'];
                                                            $bp_user = mysqli_query($link, "SELECT * FROM users WHERE id = '$id'");
                                                            $user = mysqli_fetch_array($bp_user);
                            ...
                            <a href="sBPvm.php" class="btn btn-primary">View More</a>
                        </div>
                    </div>
